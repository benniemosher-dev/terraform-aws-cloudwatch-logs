...
![CI Terraform](https://github.com/benniemosher-dev/terraform-aws-cloudwatch-logs/actions/workflows/ci-terraform.yml/badge.svg)

🪵 A TF module for AWS Cloudwatch Logs. 🪵
